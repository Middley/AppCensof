...
class _LoginPageState extends State<LoginPage> {
  ...
  signIn(String name, pass) async {
    ...
    var response = await http
        .post(Uri.parse("http://192.168.1.34:8000/api/login"), body: data);
  ...
  Container buttonSection() {
    return Container(
      ...
      child: RaisedButton(
        onPressed: nameController.text == "" || passwordController.text == ""
            ? null
            : () {
                setState(() {
                  _isLoading = true;
  ...
  //declaramos los controladores para el app
